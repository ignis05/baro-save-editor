...
For offline uses electron build can be self compiled with `npm run electron:build` or downloaded from [the latest release](https://github.com/ignis05/baro-save-editor/releases/latest).
<br>
